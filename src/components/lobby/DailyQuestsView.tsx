...
import { FaTasks, FaCheck, FaClock, FaTimes, FaSync, FaTrophy, FaRobot, FaDice } from 'react-icons/fa';
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                title="Generar nuevas misiones diarias"
              >
                <FaDice className="text-sm" />
                <span className="text-sm">Rerollear</span>
              </button>
              <button
                onClick={onClose}
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-lg p-4 mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-white font-bold text-lg">Alimentos Disponibles</div>
                    <div className="text-green-200 text-sm">Recompensa de misiones diarias</div>
                  </div>
                </div>
                <div className="text-3xl font-bold text-white">{availableFood}</div>
              </div>
            </div>
          )}
              ...
              {dailyQuests.map((quest) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="text-center">
                        <div className={`font-bold ${quest.completed ? 'text-green-400' : 'text-blue-400'}`}>
                          {quest.progress}/{quest.target}
                        </div>
                        <div className="text-gray-400 text-xs">Progreso</div>
                      </div>
                      <div className="text-center">
                        <div className="font-bold text-yellow-400">🍎 {quest.reward}</div>
                      ...
                      {quest.completed && (
                        <div className="flex items-center space-x-2 bg-green-600/20 border border-green-500/50 rounded-lg px-3 py-2">
                          ...
                          <span className="text-green-400 font-bold text-sm">Completada</span>
                        </div>
                      )}
                    </div>
                  </div>
